const API_URL= "http://www.omdbapi.com/?i=tt3896198&apikey=472926a7&s=";
const API_URL_SEARCH="http://www.omdbapi.com/?apikey=472926a7&i=";
...
movieElm.innerHTML=`
<div class= "card"><img src="${imovie.Poster}" alt="Poster" width ="300px"  height ="300px"/>
<br>
    <div class="movie.description">
       ...
       <span class="movie-title><b>title</b><span class="value">${imovie.Relesased}</span></span>
